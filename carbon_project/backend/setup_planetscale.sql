-- Carbon Footprint Database Schema for PlanetScale
-- Run this in PlanetScale Console or MySQL client

-- Database should already be created in PlanetScale dashboard
