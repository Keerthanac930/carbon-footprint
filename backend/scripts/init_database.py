#!/usr/bin/env python3
"""
Database initialization script for Carbon Footprint Application
"""
...
from app.database.schema import *  # Import all schema definitions
...
def main():
    ...
    print("🚀 Initializing Carbon Footprint Database...")
    print("=" * 50)
    ...
    print("2. Run the FastAPI application: uvicorn app.main:app --reload")
